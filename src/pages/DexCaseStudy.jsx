        ...
        <div className="min-h-screen bg-[#0B0E14] text-white selection:bg-blue-500/30 overflow-hidden relative">
            ...
            <main className="pt-12 md:pt-32 pb-20 md:px-6 max-w-[1100px] mx-auto space-grotesk-font relative z-10">
                ...
                <div className="text-center mb-12 md:mb-20 space-y-6 md:space-y-8">
                    <Reveal width="100%">
                        <h1 className="text-3xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-500 to-indigo-600 mb-6 drop-shadow-2xl">
                            DEX Swap Interface
                        </h1>
                    </Reveal>
                ...
                <div className="space-y-12 md:space-y-24">
                    ...
                    <Reveal width="100%">
                        <section className="bg-gradient-to-br from-[#111620] to-[#0B0E14] p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] border border-gray-800/50 relative overflow-hidden">
                            ...
                            <h2 className="text-xl md:text-5xl font-bold mb-8 flex items-center gap-2 md:gap-4 relative z-10">
                                <Repeat className="w-6 h-6 md:w-10 md:h-10 text-blue-400" />
                                <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-500 text-start tetx-nowrap">The Future of Trading</span>
                            </h2>
                            ...
                            <div className="grid md:grid-cols-2 gap-12 text-gray-400 leading-relaxed font-light text-lg relative z-10 text-left">
                                <div>
                                    ...
                                    <ul className="space-y-3 list-disc pl-4 marker:text-blue-500 text-sm md:text-[17px]">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <Reveal width="100%">
                            <div className="h-full bg-[#111620]/30 p-4 md:p-10 rounded-[2rem] md:rounded-[2.5rem] border border-gray-800/30 hover:border-blue-500/30 transition-colors text-left">
                                ...
                                <p className="text-gray-400 text-lg leading-relaxed mb-6 text-sm md:text-[17px]">
                    ...
                    <Reveal width="100%">
                        <div className="bg-gradient-to-r from-blue-900/20 to-indigo-900/20 p-4 md:p-16 rounded-[2rem] md:rounded-[3rem] border border-blue-500/20 text-center relative overflow-hidden">
                            ...
                            <h3 className="text-2xl md:text-4xl font-black text-white mb-6">Project Outcome</h3>
