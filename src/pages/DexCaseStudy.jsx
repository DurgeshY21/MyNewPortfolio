...
const DexCaseStudy = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0B0E14] text-white selection:bg-green-500/30 overflow-hidden relative">
            <Navbar />

            {/* Background Glow Effects - Green/Blue for Dex */}
            <div className="fixed top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
                <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-emerald-900/10 rounded-full blur-[120px]"></div>
                <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-teal-900/10 rounded-full blur-[120px]"></div>
            </div>
            ...
            <main className="pt-32 pb-20 px-6 max-w-[1100px] mx-auto space-grotesk-font relative z-10">
                ...
                <div className="text-center mb-20 space-y-8">
                    <Reveal width="100%">
                        <h1 className="text-5xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-600 mb-6 drop-shadow-2xl">
                            DEX Swap Interface
                        </h1>
                    </Reveal>
                    ...
                    <Reveal width="100%">
                        <p className="text-gray-400 text-lg md:text-2xl max-w-3xl mx-auto leading-relaxed font-light">
                            A high-performance <span className="text-emerald-400 font-semibold">decentralized exchange</span> interface offering seamless token swaps, liquidity pool management, and real-time market charts.
                        </p>
                    </Reveal>

                    <Reveal width="100%">
                        <div className="pt-8 flex justify-center">
                            <a href="#" className="group relative inline-flex items-center gap-3 px-8 py-4 bg-emerald-600/10 hover:bg-emerald-600 text-emerald-400 hover:text-white font-bold rounded-full transition-all duration-300 border border-emerald-500/30 hover:border-emerald-500 hover:shadow-[0_0_30px_rgba(16,185,129,0.5)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-24">
                    {[
                        { label: "TYPE", value: "DeFi Application", icon: "💸" },
                        { label: "CATEGORY", value: "Fintech / Trading", icon: "📈" },
                        { label: "SECURITY", value: "Audited", icon: "🔐" },
                        { label: "STACK", value: "Next.js • Web3 • Ethers", icon: "⚡" }
                    ].map((stat, index) => (
                        <Reveal key={index} delay={index * 0.1} width="100%">
                            <div className="h-full bg-[#111620]/40 backdrop-blur-md p-8 rounded-2xl border border-gray-800/50 hover:border-emerald-500/50 hover:bg-[#111620]/60 transition-all duration-300 flex flex-col items-center text-center group">
                                <div className="w-14 h-14 bg-emerald-900/20 rounded-full flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform duration-300">
                                    {stat.icon}
                                </div>
                ...
                <div className="space-y-24">
                            ...
                            <div className="grid md:grid-cols-2 gap-12 text-gray-400 leading-relaxed font-light text-lg relative z-10">
                                <div>
                                    <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                                        <span className="w-2 h-8 bg-emerald-500 rounded-full"></span> Overview
                                    </h3>
                                    <p className="mb-6">
                                        This <strong className="text-white">DEX Swap Interface</strong> was built to solve the fragmentation and complexity often found in decentralized exchanges.
                                    </p>
                                    <p>
                                        It focuses on a clean, minimal UI and robust smart contract integration to allow users to swap tokens and provide liquidity with confidence and ease.
                                    </p>
                                </div>
                                ...
                                <div className="bg-[#0B0E14]/50 p-8 rounded-2xl border border-gray-800/30">
                                    ...
                                    <ul className="space-y-3">
                                        {[
                                            ...
                                            { name: "Web3.js / Ethers", desc: "Blockchain Interaction" },
                                            { name: "The Graph", desc: "On-Chain Data Indexing" },
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <Reveal width="100%">
                            <div className="h-full bg-[#111620]/30 p-10 rounded-[2.5rem] border border-gray-800/30 hover:border-emerald-500/30 transition-colors">
                                <h3 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                                    <span className="text-pink-400">🎨</span> My Role
                                </h3>
                                <p className="text-gray-400 text-lg leading-relaxed mb-6">
                                    I served as the <strong className="text-white">Full Stack Engineer</strong>, bridging the gap between complex smart contracts and a user-friendly frontend.
                                </p>
                                <ul className="space-y-4 text-gray-400">
                                    <li className="flex gap-4">
                                        <span className="w-6 h-6 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center text-sm font-bold mt-1">1</span>
                                        <span>Integrated multi-wallet connection logic (MetaMask, WalletConnect).</span>
                                    </li>
                                    <li className="flex gap-4">
                                        <span className="w-6 h-6 rounded-full bg-cyan-500/20 text-cyan-400 flex items-center justify-center text-sm font-bold mt-1">2</span>
                                        <span>Ensured accurate real-time price feeds and gas estimation.</span>
                                    </li>
                                    <li className="flex gap-4">
                                        <span className="w-6 h-6 rounded-full bg-purple-500/20 text-purple-400 flex items-center justify-center text-sm font-bold mt-1">3</span>
                            ...
                            <div className="h-full bg-[#111620]/30 p-10 rounded-[2.5rem] border border-gray-800/30 hover:border-yellow-500/30 transition-colors">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={i} className="group flex items-center gap-4 p-4 rounded-xl bg-[#0B0E14] border border-gray-800 hover:border-emerald-500/50 transition-all cursor-default">
                    ...
                    <Reveal width="100%">
                        <div className="relative">
                            <div className="absolute left-1/2 -top-10 -translate-x-1/2 w-1/2 h-full bg-emerald-500/5 blur-[100px] -z-10"></div>
                    ...
                    {/* Outcome */}
                    <Reveal width="100%">
                        <div className="bg-gradient-to-r from-emerald-900/20 to-teal-900/20 p-10 md:p-16 rounded-[3rem] border border-emerald-500/20 text-center relative overflow-hidden">
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-emerald-500 to-transparent"></div>

                            <span className="text-6xl mb-6 block">🚀</span>
                            <h3 className="text-4xl font-black text-white mb-6">Project Outcome</h3>
                            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-10">
                                The DEX interface facilitated over <span className="text-white font-bold">$1M in Beta Volume</span>. Users praised the <span className="text-emerald-400">clean UI</span> and transparency, making decentralized trading accessible to beginners.
                            </p>
