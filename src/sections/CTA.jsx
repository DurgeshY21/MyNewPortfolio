        ...
        <section className="relative w-full py-24 px-6 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center text-center z-10 relative">
                ...
                <div className="mb-8 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
                    ...
                    <span className="text-gray-300 text-xs font-bold tracking-widest uppercase">Available for projects</span>
                </div>
                ...
                {/* Stats Grid */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full max-w-4xl mx-auto mb-16 border-y border-white/5 py-12">
                    <div className="flex flex-col items-center justify-center p-4">
                        <span className="text-4xl md:text-5xl font-bold text-white mb-2">50+</span>
                        <span className="text-gray-500 text-xs font-bold tracking-widest uppercase">Projects</span>
                    </div>
                    <div className="flex flex-col items-center justify-center p-4 md:border-x border-white/5">
                        ...
                        <span className="text-gray-500 text-xs font-bold tracking-widest uppercase">Years Exp</span>
                    </div>
                    <div className="flex flex-col items-center justify-center p-4">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 mb-12 w-full md:w-auto">
                    <a href="#contact" className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-400 rounded-full text-white font-bold text-lg transition-all hover:scale-105 w-full md:w-auto flex items-center justify-center gap-2">
                        START YOUR PROJECT
                    ...
                    <a href="#contact" className="group px-8 py-4 bg-transparent border border-white/10 rounded-full text-white font-bold text-lg hover:bg-white/5 transition-all w-full md:w-auto flex items-center justify-center">
                        SCHEDULE A CALL
                    </a>
                </div>
