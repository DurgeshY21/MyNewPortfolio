    ...
    const skills = [
        {
            ...
            text: "Sr. Frontend Developer skilled in HTML5, CSS3, TailwindCSS, JavaScript, and modern frameworks like React.js and Next.js."
        },
        {
            icon: (
            ...
            text: "Currently working as a Lead Frontend Engineer, architecting scalable web solutions."
        },
        {
            icon: (
        ...
        },
        {
            ...
            text: "Enthusiastic about code refactoring, writing reusable components, and maintainable, clean codebases."
        },
        {
            icon: (
            ...
            text: "Strong understanding of web performance, Core Web Vitals, and SEO best practices."
        }
    ];
