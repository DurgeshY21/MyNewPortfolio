    ...
    return (
        <section id="home" className="relative w-full min-h-screen flex items-center justify-center pt-0 px-6 max-w-7xl mx-auto overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
                ...
                <div className="flex flex-col items-start justify-start text-left space-y-8 z-10">
                    {/* Status Badge */}
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20">
                        ...
                        <span className="text-blue-400 text-xs font-semibold tracking-wider uppercase">Available for new projects</span>
                    </div>
                    ...
                    {/* Description */}
                    <p className="text-gray-400 text-lg max-w-lg leading-relaxed text-left">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        <a href="#projects" className="group px-8 py-3.5 rounded-full border border-blue-500/50 text-blue-400 font-semibold hover:bg-blue-500/10 transition-all flex items-center gap-2">
                            View My Work
