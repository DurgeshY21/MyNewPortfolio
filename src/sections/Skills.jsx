...
const Skills = () => {
    ...
    return (
        <section id="skills" className="relative w-full py-20 px-6 max-w-7xl mx-auto flex flex-col items-center">
                        ...
                        {[
                            ...
                            <div key={skill.name} className="flex flex-col items-center gap-4">
                                <div className="relative h-24 w-24">
                                    ...
                                    <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-xl font-bold">
                                        {skill.pct}%
                                    </span>
                                </div>
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            <div key={tool} className="flex items-center gap-4 group">
                                ...
                                <span className="text-lg font-medium text-white group-hover:text-cyan-400 transition-colors">{tool}</span>
                            </div>
                        ))}
                    </div>
                </div>
